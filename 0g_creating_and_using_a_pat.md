...
If you don't need to use a PAT yet (because it's not your first day of Epicodus), there's no need to copy this yet. You can refer back to this lesson when you get to [Practice: GitHub Remote Repositories](/introduction-to-programming/git-html-and-css-part-2/github-and-remote-repositories) on your first day of class.

## [Using a PAT](#using-a-pat)

---

In [Practice: GitHub Remote Repositories](/introduction-to-programming/git-html-and-css-part-2/github-and-remote-repositories), you'll push code to a remote repository (in your GitHub account) for the first time.

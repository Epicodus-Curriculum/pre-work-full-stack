...
[Installation](/pre-work/getting-started-with-working-remotely/installing-and-using-vs-code-live-share#installation)
 
[Sharing Code](/pre-work/getting-started-with-working-remotely/installing-and-using-vs-code-live-share#sharing-code)
 
[Sharing the Terminal](/pre-work/getting-started-with-working-remotely/installing-and-using-vs-code-live-share#sharing-the-terminal)
...
If you haven't already installed VS Code by following along with the previous lesson, do so now. [Instructions are located here](/pre-work/getting-started-with-intro-to-programming/text-editor-visual-studio-code).

...
As a general reminder, **before the start of class you should make sure to read through all of the sections listed as pre-work in the [Introduction to Programming Course](https://full-time.learnhowtoprogram.com/introduction-to-programming/).** After you complete those readings, you will be ready to go for the first day of class!